import inherit.Rectangle as dynamicObjects
import inherit.Graphics
import pygame
class Player(dynamicObjects.Rectangle):
    ...
    def draw(self):
        self.id=self.canvas.create_image("sprites\character.png", 550, 550, self.width, self.length)
    ...
    def animation(self):
        if int(self.yVelocity)<0:
            self.canvas.replace_image(self.id, "sprites\jump2.png", 550, 550, self.width, self.length)
            if self.xVelocity<0:
            ...
            self.canvas.replace_image(self.id, "sprites\character.png", 550, 550, self.width, self.length)


    def runAnimation(self):
        if self.frame == 0:
            self.canvas.replace_image(self.id, "sprites\run1.png", 550, 550, self.width, self.length)
            self.LeftFace = True
            ...
            self.canvas.replace_image(self.id, "sprites\run2.png", 550, 550, self.width, self.length)
            self.LeftFace = True
            if self.frameCounter>5:
                self.frameCounter=0
                self.frame = 2
            ...
            self.canvas.replace_image(self.id, "sprites\run3.png", 550, 550, self.width, self.length)
            self.LeftFace = True
            if self.frameCounter<5:
                self.frameCounter=0
                self.frame = 0
